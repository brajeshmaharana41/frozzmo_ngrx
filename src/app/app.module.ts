...
import { Cart_Effects } from './store/add_item_to_cart/cart_Effect';
...
@NgModule({
  ...
  imports: [
    ...
    EffectsModule.forRoot([Product_Effects, Category_Effects, Brand_Effects, Color_Effects, Price_Effects, Cart_Effects])
  ],
  providers: [
    MatDatepickerModule,
    MatNativeDateModule,
